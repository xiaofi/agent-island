...
use crate::{
    adapters::{
        claude_code, codex,
        types::{
            AdapterDiagnostic, AgentEvent, AgentEventType, AgentSource, AgentTask, AppSettings,
            CandidatePath, TaskStatus,
        },
    },
...
pub fn load_tasks_with_fallback(settings: &AppSettings) -> Vec<AgentTask> {
    let mut tasks = load_tasks(settings);
